    ...
    <>
      ...
      <section className="py-12 px-4 md:px-8 lg:px-16 bg-white">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-gray-700 text-lg mb-6">
            At <span className="font-semibold">Techware Solution</span>, we
            specialize in developing high-quality, high-performance mobile
            applications tailored to the unique requirements of businesses.
            Whether you are a startup, small business, or established
            enterprise, our experienced team delivers innovative mobile
            solutions designed to support your growth and digital
            transformation goals.
          </p>

          <p className="text-gray-700 text-lg mb-6">
            We develop Android and iOS applications using native technologies
            such as <span className="font-medium">Kotlin, Java, and Swift</span>
            , as well as modern cross-platform frameworks including{" "}
            <span className="font-medium">React Native</span> and{" "}
            <span className="font-medium">Flutter</span>. This approach enables
            efficient development, optimized project costs, and a consistent
            user experience across multiple platforms.
          </p>

          <p className="text-gray-700 text-lg mb-6">
            Our process begins with understanding your business objectives,
            target audience, and technical requirements. From strategy and
            wireframing to development, testing, deployment, and ongoing
            support, we deliver scalable, secure, and reliable mobile
            applications designed for long-term success.
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-12 text-left mt-10">
            <div>
              ...
              <ul className="list-disc list-inside text-gray-700 space-y-2">
                ...
                <li>Application Testing & Deployment</li>
              </ul>
            </div>
      ...
      <section className="py-12 px-4 md:px-8 lg:px-16 bg-white">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="w-full md:w-1/2">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4 leading-snug">
              We create innovative mobile solutions that address real-world
              challenges, enhance user engagement, and support business growth.
            </h2>
            ...
            <ul className="list-disc list-inside text-lg text-gray-800 space-y-2 mb-6">
              ...
              <li>App Store and Google Play Store Deployment</li>
              <li>Third-Party API Integrations</li>
              <li>Backend Development and Cloud Integration</li>
              <li>Android and iOS Native App Development</li>
            </ul>

            <p className="text-gray-700 text-lg mb-4">
              From concept validation to post-launch support,
              <span className="font-semibold"> Techware Solution</span>
              provides end-to-end mobile application development services
              tailored to your business objectives.
            </p>

            <p className="text-gray-700 text-lg">
              Our expertise spans a wide range of industries, including
              e-commerce, healthcare, education, logistics, and other
              technology-driven sectors. We focus on building reliable,
              scalable, and user-centric applications that help organizations
              achieve their digital goals.
            </p>

            <p className="text-gray-700 text-lg mt-4">
              Partner with us to develop a mobile application that meets
              current business requirements while remaining adaptable to future
              opportunities, powered by innovation, strategic planning, and
              modern technology.
            </p>
          </div>
        </div>
