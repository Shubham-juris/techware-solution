    ...
    <>
      ...
      <section className="py-12 px-4 md:px-8 lg:px-16 bg-white">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-gray-700 text-lg mb-6">
            In today’s digital marketplace, a strong online presence requires
            more than visibility—it requires a strategic approach that drives
            measurable business outcomes. At{" "}
            <span className="font-semibold">Techware Solution</span>, we provide
            comprehensive digital marketing services designed to increase brand
            visibility, generate qualified leads, and support long-term
            business growth.
          </p>

          <p className="text-gray-700 text-lg mb-6">
            Our team combines market insights, creative execution, and
            performance analytics to deliver measurable marketing results.
            Whether you are an emerging startup or an established organization,
            we tailor our strategies to align with your business objectives,
            target audience, and industry requirements.
          </p>

          <p className="text-gray-700 text-lg mb-6">
            We focus on every key aspect of digital marketing—from brand
            awareness and audience engagement to lead generation and conversion
            optimization. By leveraging a strategic mix of{" "}
            <span className="font-medium">
              SEO, social media marketing, content marketing, and paid
              advertising
            </span>
            , we help businesses build a strong and sustainable digital
            presence.
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-12 text-left mt-10">
            ...
            <div>
              ...
              <ul className="list-disc list-inside text-gray-700 space-y-2">
                ...
                <li>Results-Oriented Marketing Campaigns</li>
              </ul>
            </div>
          </div>
      ...
      <section className="py-12 px-4 md:px-8 lg:px-16 bg-white">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="w-full md:w-1/2">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4 leading-snug">
              Comprehensive Digital Marketing Solutions for Sustainable Business
              Growth
            </h2>
            ...
            <p className="text-gray-700 text-lg mb-4">
              At{" "}
              <span className="font-semibold">Techware Solution</span>, we focus
              on attracting qualified audiences, strengthening brand visibility,
              and creating meaningful customer engagement. Our digital marketing
              strategies are designed to support sustainable growth and improve
              overall marketing performance.
            </p>

            <p className="text-gray-700 text-lg">
              Through data-driven decision-making, continuous optimization, and
              industry best practices, we help businesses maximize the value of
              their marketing investments while building a strong competitive
