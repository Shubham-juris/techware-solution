    ...
    <>
      ...
      <section className="py-10 px-4 md:px-8 lg:px-16 bg-white">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-gray-700 text-lg mb-6 leading-relaxed">
            At <span className="font-semibold">Techware Solution</span>, we
            develop modern, responsive, and performance-driven websites tailored
            to your business requirements. In today’s digital landscape, a
            website serves as the core of your online presence and plays a key
            role in shaping customer trust and engagement.
          </p>

          <p className="text-gray-700 mb-6 leading-relaxed">
            We work with technologies such as HTML5, CSS3, JavaScript, React.js,
            Next.js, Node.js, and more to build scalable and efficient web
            solutions. Our focus is on delivering fast, secure, SEO-friendly, and
            mobile-optimized applications that support business growth.
          </p>

          <p className="text-gray-700 leading-relaxed">
            From initial planning and UI/UX design to development, deployment,
            and long-term maintenance, we follow a structured and
            quality-driven approach to ensure reliable digital solutions.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 mt-12 text-left">
            ...
            <div>
              ...
              <ul className="list-disc list-inside text-gray-700 space-y-4">
                ...
                <li>Responsive and mobile-first development approach</li>
                <li>SEO-optimized and high-performance websites</li>
                <li>API and third-party integration support</li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc list-inside text-gray-700 space-y-4">
                <li>React.js, Next.js, and Node.js Development</li>
                <li>WordPress and Headless CMS Solutions</li>
      ...
      <section className="py-12 px-4 md:px-8 lg:px-16 bg-white">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="w-full md:w-1/2">
            ...
            <p className="text-gray-700 text-lg mb-4">
              We combine strong development practices with UI/UX principles to
              build websites that are visually engaging, user-friendly, and
              conversion-focused. Our development process ensures both design
              consistency and technical reliability.
            </p>

            <p className="text-gray-700 text-lg">
              With experience across multiple industries,{" "}
              <span className="font-semibold">Techware Solution</span> helps
              businesses establish a strong digital presence through reliable,
              scalable, and future-ready web solutions.
            </p>
          </div>
        </div>
      </section>
